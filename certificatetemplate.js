...
module.exports = (organizer_name,participant_name,date,event_name,share_id,college_name) => {
...
<div class="bottomDiv">
    <p class="eight">Verify at https://ellipseapp.com/verify_certificate/${share_id}</p>
