**The information contained herein, including code, documentations, media files, comments, methods, know-how, and intelledcutal property, is confidential and proprietary information of Reality Labs, Inc. Do not distribute.**
...
## Installation
```
$ git clone https://github.com/AgentAvery/userapp.git
$ cd userapp
$ npm install
```
